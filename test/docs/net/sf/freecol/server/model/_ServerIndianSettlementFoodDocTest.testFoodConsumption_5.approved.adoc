...
GoodsCount for image:{ROOT_PATH}/../../data/default/resources/images/goods/food.png[title="food"]: 0
...
GoodsCount for image:{ROOT_PATH}/../../data/default/resources/images/goods/food.png[title="food"]: 4
